...
class IntranetDB {
  ...
  async updateProject (data, name, callback) {
    try {
  ...
  async updateOffice (data, name, callback) {
    try {
  ...
  async getDepartment (name, callback) {
    try {
  ...
  async deleteDeparment (name, callback) {
    try {
      const result = await this.getDepartment(name)
      if (!result) throw new Error('not found')
      const deleted = JSON.parse(JSON.stringify(result))
      await result.destroy()
      return Promise.resolve(deleted).asCallback(callback)
  ...
  async getDocument (name, callback) {
    try {
  ...
  async deleteDocument (name, callback) {
    try {
      const result = await this.getDocument(name)
      if (!result) throw new Error('not found')
      const deleted = JSON.parse(JSON.stringify(result))
      await result.destroy()
      return Promise.resolve(deleted).asCallback(callback)
