...
class IntranetDB {
  ...
  async saveProjectCategory (projectCategory, callback) {
    try {
      const created = await models.ProjectCategory.create(projectCategory)
  ...
  async getProjectCategory (id, callback) {
    try {
      const result = await models.ProjectCategory.findOne({
        where: { id }
      })
  ...
  async getProjectCategories (callback) {
    try {
      const result = await models.ProjectCategory.findAll()
      if (!result) throw new Error('not found')
      return Promise.resolve(result).asCallback(callback)
    } catch (e) {
      return Promise.reject(e).asCallback(callback)
  ...
  async updateProjectCategory (id, data, callback) {
    try {
      const result = await this.getProjectCategory(id)
  ...
  async deleteProjectCategory (id, callback) {
    try {
      const result = await this.getProjectCategory(id)
      if (!result) throw new Error('not found')
  ...
  async getProjectsByProjectCategory (projectCategoryId, callback) {
    try {
      const projects = await models.Project.findAll({
  ...
  async updateDocument (id, data, callback) {
    try {
